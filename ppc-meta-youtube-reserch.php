...
<head>
    ...
    <title>PPC, Meta, and YouTube Ads Market Report</title>
    <style>
        :root {
...
<body>
    <div id="ppcAdsSampleModal" class="modal-overlay">
        <div class="modal-content" id="modalContent">
            <span class="close-button" id="modalCloseButton">×</span>
            <h2 class="section-title" id="modalTitle">Request Free Sample</h2>
            <p class="text-paragraph" id="modalDescription">Please fill out this form to download the free PPC, Meta, and YouTube Ads market report sample.</p>

            <form id="ppcAdsSampleForm" class="form-container">
    ...
    <header class="header-section" id="mainHeader">
        <div class="main-container" id="headerContainer">
            <h1 class="main-title" id="reportTitle">PPC, Meta, and YouTube Ads Market Report</h1>
            <p class="text-paragraph" id="reportSubtitle">Global Analysis & Forecasts 2024-2030</p>
            <!-- <button id="openPPCAdsModal" class="primary-button">Request Free Sample</button> -->
        </div>
    </header>
    ...
    <div class="main-container" id="mainContent">
        <div class="info-container" id="marketHighlights">
            ...
            <p class="text-paragraph">The global PPC, Meta, and YouTube Ads market was valued at <strong>USD 28.5 billion in 2024</strong> and is projected to grow at a <strong>CAGR of 12.3%</strong> from 2025 to 2030, reaching <strong>USD 58.7 billion by 2030</strong>.</p>
            <p class="text-paragraph">Key drivers include the increasing reliance on targeted advertising, the growth of video advertising on YouTube, and advancements in Meta’s ad targeting capabilities.</p>
        </div>
    ...
    <script>
        // Modal functionality
        const modal = document.getElementById("ppcAdsSampleModal");
        const openModalBtn = document.getElementById("openPPCAdsModal");
        const closeBtn = document.getElementById("modalCloseButton");
        const sampleForm = document.getElementById("ppcAdsSampleForm");
        ...
        sampleForm.onsubmit = function(e) {
            ...
            console.log("PPC, Meta, and YouTube Ads Sample Request Form Data:", formData);
        ...
        function generateSamplePDF(formData) {
            const content = `
                PPC, Meta, and YouTube Ads Market Report - Sample
                ====================================================
                
                Thank you for your interest, ${formData.name}!
                
                This sample report contains key highlights from our full PPC, Meta, and YouTube Ads market analysis.
            ...
            a.href = url;
            a.download = 'PPC_Meta_YouTube_Ads_Market_Report_Sample.pdf';
        ...
        window.onload = function() {
            renderChart('ppcAdsGrowthChart', ppcAdsMarketSizeData, true);
