...
<body>
    <div id="erpSampleModal" class="modal-overlay">
        <div class="modal-content" id="modalContent">
            <span class="close-button" id="modalCloseButton">×</span>
            <h2 class="section-title" id="modalTitle">Request Free Sample</h2>
            <p class="text-paragraph" id="modalDescription">Please fill out this form to download the free ERP market report sample.</p>

            <form id="erpSampleForm" class="form-container">
    ...
    <header class="header-section" id="mainHeader">
        <div class="main-container" id="headerContainer">
            <h1 class="main-title" id="reportTitle">Enterprise Resource Planning (ERP) Market Report</h1>
            <p class="text-paragraph" id="reportSubtitle">Global Analysis & Forecasts 2024-2030</p>
            <!-- <button id="openErpModal" class="primary-button">Request Free Sample</button> -->
        </div>
    </header>
    ...
    <div class="main-container" id="mainContent">
        <div class="info-container" id="marketHighlights">
            ...
            <p class="text-paragraph">The global ERP market was valued at <strong>USD 54.2 billion in 2024</strong> and is projected to grow at a <strong>CAGR of 10.8%</strong> from 2025 to 2030, reaching <strong>USD 101.3 billion by 2030</strong>.</p>
            <p class="text-paragraph">Key drivers include digital transformation, cloud-based ERP adoption, and increasing demand for integrated business processes across industries.</p>
        </div>
    ...
    <script>
        // Modal functionality
        const modal = document.getElementById("erpSampleModal");
        const openModalBtn = document.getElementById("openErpModal");
        const closeBtn = document.getElementById("modalCloseButton");
        const sampleForm = document.getElementById("erpSampleForm");
        ...
        sampleForm.onsubmit = function(e) {
            ...
            console.log("ERP Sample Request Form Data:", formData);
        ...
        function generateSamplePDF(formData) {
            const content = `
                ERP Market Report - Sample
                ====================================================
                
                Thank you for your interest, ${formData.name}!
                
                This sample report contains key highlights from our full ERP market analysis.
                ...
                - Market Size (2024): $54.2 billion
                - Projected CAGR (2025-2030): 10.8%
                - 2030 Projection: $101.3 billion
            ...
            a.href = url;
            a.download = 'ERP_Market_Report_Sample.pdf';
        ...
        window.onload = function() {
            renderChart('erpGrowthChart', erpMarketSizeData, true);
