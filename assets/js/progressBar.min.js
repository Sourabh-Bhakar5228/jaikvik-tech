!(function (r, t) {
  ...
  function o(o, n = {}) {
    ...
    const e = (r) => i.el.data(r),
      ...
      P =
        void 0 === y
          ? e("fill") || "linear-gradient(to left, #148cfa, #64f5d2)"
          : y,
      C = n.border,
    ...
    i.el.addClass("progress-" + W),
      (i.bar = i.el.find(".ab-progress-bar")),
      (i.title = i.el.find(".progress-title")),
      (i.indecator = i.el.find(".progress-indicator")),
      (i.numWrap = i.indecator.find(".progress-indicator-inner")),
      (i.number = i.indecator.find(".percent"));
    (i.started = !1),
      (i.stopped = null),
      (i.animator = null),
      (i.progress = 0),
      (i.start = function () {
        i.started ||
          ((i.animator = r({ Progress: i.progress }).animate(
            { Progress: a },
            {
              duration: A,
              easing: B,
      ...
      (i.stop = function (r = !1, t = !1) {
        i.stopped ||
          (i.animator.stop(r, t), (i.started = !1), (i.stopped = !0));
      }),
      r.isFunction(z) && z.call(i),
      !i.title.length &&
        l &&
        ((i.title = r(c).addClass("progress-title")),
        i.title.text(g),
        i.el.html(i.title)),
      i.indecator.length ||
        ((i.indecator = r("<div/>").addClass("progress-indicator")),
        i.title.after(i.indecator)),
      i.number.length ||
        ((i.number = r('<span class="percent"></span>')),
        i.number.appendTo(i.indecator),
        i.number.wrap('<div class="progress-indicator-inner"/>'),
        (i.numWrap = i.number.parent()),
        "tooltip" === W && i.number.after('<span class="down-arrow"/>')),
      i.bar.length ||
        ((i.bar = r("<div/>").addClass("ab-progress-bar")),
        i.indecator.after(i.bar),
        i.bar.wrap('<div class="progress-bar-wrap"/>'),
        (i.wrap = i.el.find(".progress-bar-wrap"))),
      R && i.el.addClass("progress-rtl"),
      T &&
        (I && t.Waypoint
          ? new Waypoint({
              element: i.el[0],
