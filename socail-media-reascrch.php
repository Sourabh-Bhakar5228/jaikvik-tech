...
<head>
    ...
    <title>Social Media Marketing Market Report</title>
    <style>
        :root {
...
<body>
    <div id="socialMediaMarketingSampleModal" class="modal-overlay">
        <div class="modal-content" id="modalContent">
            <span class="close-button" id="modalCloseButton">×</span>
            <h2 class="section-title" id="modalTitle">Request Free Sample</h2>
            <p class="text-paragraph" id="modalDescription">Please fill out this form to download the free Social Media Marketing market report sample.</p>

            <form id="socialMediaMarketingSampleForm" class="form-container">
    ...
    <header class="header-section" id="mainHeader">
        <div class="main-container" id="headerContainer">
            <h1 class="main-title" id="reportTitle">Social Media Marketing Market Report</h1>
            <p class="text-paragraph" id="reportSubtitle">Global Analysis & Forecasts 2024-2030</p>
            <!-- <button id="openSocialMediaMarketingModal" class="primary-button">Request Free Sample</button> -->
        </div>
    </header>
    ...
    <div class="main-container" id="mainContent">
        <div class="info-container" id="marketHighlights">
            ...
            <p class="text-paragraph">The global social media marketing market was valued at <strong>USD 28.5 billion in 2024</strong> and is projected to grow at a <strong>CAGR of 12.3%</strong> from 2025 to 2030, reaching <strong>USD 58.7 billion by 2030</strong>.</p>
            <p class="text-paragraph">Key drivers include the increasing adoption of social media platforms, demand for targeted advertising, and advancements in analytics and AI-driven marketing solutions.</p>
        </div>
    ...
    <script>
        // Modal functionality
        const modal = document.getElementById("socialMediaMarketingSampleModal");
        const openModalBtn = document.getElementById("openSocialMediaMarketingModal");
        const closeBtn = document.getElementById("modalCloseButton");
        const sampleForm = document.getElementById("socialMediaMarketingSampleForm");
        ...
        sampleForm.onsubmit = function(e) {
            ...
            console.log("Social Media Marketing Sample Request Form Data:", formData);
        ...
        function generateSamplePDF(formData) {
            const content = `
                Social Media Marketing Market Report - Sample
                ====================================================
                
                Thank you for your interest, ${formData.name}!
                
                This sample report contains key highlights from our full Social Media Marketing market analysis.
            ...
            a.href = url;
            a.download = 'Social_Media_Marketing_Market_Report_Sample.pdf';
        ...
        const socialMediaMarketingMarketSizeData = [{
                year: '2024',
                value: 28.5
            },
            {
        ...
        window.onload = function() {
            renderChart('socialMediaMarketingGrowthChart', socialMediaMarketingMarketSizeData, true);
