...
<body>
    ...
    <section class="clientWork">
        ...
        <?php include 'home-page-technolgy.php' ?>


        <!-- Reel Slider  -->
        <div class="swiper reelSwiper">
            <div class="reelHeading">
                <h2 class="text-uppercase"><a href="#">Social Media Reels <span> </span></a></h2>
            </div>
        ...
        <div class="swiper postSwiper">
            <div class="postHeading">
                <h2 class="text-uppercase"><a href="#">Social Media Posts <span> </span></a></h2>
            </div>
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="postCard">
    ...
    <section class="testSection">
        <div class="swiper testSwiper">
            <div class="testHeading">
                <h2 class="text-uppercase"><a href="#">Our Testimonials <span> </span></a></h2>
            </div>
            <div class="swiper-wrapper">
                <div class="swiper-slide">
