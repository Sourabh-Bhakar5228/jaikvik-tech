...
<head>
    ...
    <title>Web Development Market Report</title>
    <style>
        :root {
...
<body>
    <div id="webDevelopmentSampleModal" class="modal-overlay">
        <div class="modal-content" id="modalContent">
            <span class="close-button" id="modalCloseButton">×</span>
            <h2 class="section-title" id="modalTitle">Request Free Sample</h2>
            <p class="text-paragraph" id="modalDescription">Please fill out this form to download the free Web Development market report sample.</p>

            <form id="webDevelopmentSampleForm" class="form-container">
                ...
                <div class="form-field" id="companyField">
                    <label for7201" class="form-label">Company Name</label>
    ...
    <header class="header-section" id="mainHeader">
        <div class="main-container" id="headerContainer">
            <h1 class="main-title" id="reportTitle">Web Development Market Report</h1>
            <p class="text-paragraph" id="reportSubtitle">Global Analysis & Forecasts 2024-2030</p>
            <!-- <button id="openWebDevelopmentModal" class="primary-button">Request Free Sample</button> -->
        </div>
    </header>
    ...
    <div class="main-container" id="mainContent">
        <div class="info-container" id="marketHighlights">
            ...
            <p class="text-paragraph">The global web development market was valued at <strong>USD 28.5 billion in 2024</strong> and is projected to grow at a <strong>CAGR of 12.3%</strong> from 2025 to 2030, reaching <strong>USD 58.7 billion by 2030</strong>.</p>
            <p class="text-paragraph">Key drivers include thedemand for tailored business solutions, digital transformation initiatives, and the rise of cloud-based web development.</p>
        </div>
    ...
    <script>
        // Modal functionality
        const modal = document.getElementById("webDevelopmentSampleModal");
        const openModalBtn = document.getElementById("openWebDevelopmentModal");
        const closeBtn = document.getElementById("modalCloseButton");
        const sampleForm = document.getElementById("webDevelopmentSampleForm");
        ...
        sampleForm.onsubmit = function(e) {
            ...
            console.log("Web Development Sample Request Form Data:", formData);
        ...
        function generateSamplePDF(formData) {
            const content = `
                Web Development Market Report - Sample
                ====================================================
                
                Thank you for your interest, ${formData.name}!
                
                This sample report contains key highlights from our full Web Development market analysis.
            ...
            a.href = url;
            a.download = 'Web_Development_Market_Report_Sample.pdf';
        ...
        const webDevelopmentMarketSizeData = [{
                year: '2024',
                value: 28.5
            },
            {
        ...
        window.onload = function() {
            renderChart('webDevelopmentGrowthChart', webDevelopmentMarketSizeData, true);
